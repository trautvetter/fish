...
Fish is an options organization tool for rapidly evolving bash scripts.
It allows you to concentrate on adding functionality to your script and quickly hook up switches to use it, and maintain the help/usage so that you don't forget how to use it.
...
If your function is called with longopts style switches and you want to provide short-cuts simply add a line to the config table. You can use longopts, shortopts, or bare opts.
